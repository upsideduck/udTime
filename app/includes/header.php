...
<html class="no-js"> <!--<![endif]-->
    <head>
		...
		<?php endif; ?>
		<?php
		switch (constant('__SCRIPT_NAME__')) {
			case "index" :
                    ...
                    <div class="nav-collapse collapse">
						...
						<ul class="nav pull-right">
						     <?php if ($_SESSION['SESS_MEMBER_ID']): ?>
                                <li>
                                    <?php if (isset($_SESSION['SESS_USERNAME']) && isset($_SERVER['HTTP_X_AUTHENTIK_USERNAME']) &&  $_SERVER['HTTP_X_AUTHENTIK_USERNAME'] == $_SESSION['SESS_USERNAME']): ?>
                                         <a href='logout.php'>Logged in via SSO - Logout</a>
                                    <?php else: ?>
